...
*其他平台环境类似* 
```vim
HardWare: ROG MAXIMUS XII HERO(WI-FI) / NVIDIA GTX 2080TI / DDR4 64G 3600 / SSD 2T / HDD 4T
OS：Ubuntu-16.04-64bit / Ubuntu-18.04-64bit / Windows 10 Professional
Environment：CUDA9.0-CUDA10.2 / cuDNN / TensorRT / OpenCV / caffe / YOLO-V3 / Protobuf / Matlab / VIM 
````
---
### 目录
